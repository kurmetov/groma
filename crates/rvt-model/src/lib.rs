...
pub use serial::{
    ...
    SerialString, SerialTraceEntry, SerialWalk, descends_from, record_declared_id, record_name,
    record_name_string, walk_object, walk_object_stream, walk_record, walk_record_collecting,
